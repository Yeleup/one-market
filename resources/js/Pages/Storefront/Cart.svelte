...
{#snippet children()}
<div>
    <h1 class="mb-6 text-2xl font-semibold tracking-tight text-stone-900">Корзина</h1>
    ...
    {#if items.length === 0}
        <div class="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p class="mb-1 text-sm font-medium text-stone-700">Корзина пуста</p>
            <p class="mb-4 text-xs text-stone-400">Добавьте товары из каталога</p>
                ...
                {#each items as item}
                    <div class="flex items-center gap-3 rounded-2xl border border-stone-200 bg-white p-3 sm:gap-4 sm:p-4">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="mt-0.5 text-xs text-stone-400">{item.bonus_price} бон. · {item.weight_grams} г</p>
                        </div>
                ...
                <div class="sticky top-20 rounded-2xl border border-stone-200 bg-white p-5">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex justify-between border-t border-stone-100 pt-3">
                            <span class="font-medium text-stone-900">Сумма</span>
                            <span class="text-lg font-bold text-stone-900">{totalBonuses} бон.</span>
                        </div>
                    </div>
                    <a
