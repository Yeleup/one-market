...
{#snippet children()}
<div>
    <h1 class="mb-6 text-2xl font-semibold tracking-tight text-stone-900">История бонусов</h1>
    ...
    {#if transactions.data.length === 0}
        <div class="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p class="text-sm text-stone-500">Операций пока нет</p>
        </div>
    {:else}
        <!-- Mobile: card layout -->
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-stone-100">
                            ...
                            <th class="px-4 py-3 text-right text-xs font-medium uppercase tracking-wider text-stone-400">Баланс</th>
                            <th class="px-4 py-3 text-right text-xs font-medium uppercase tracking-wider text-stone-400">Резерв</th>
                            <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-stone-400">Комментарий</th>
                        </tr>
                    </thead>
                    <tbody>
                        {#each transactions.data as tx}
