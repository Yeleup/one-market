    ...
    {:else}
        ...
        <div class="space-y-3 sm:hidden">
            {#each orders.data as order}
                <a href={order.url} class="block rounded-2xl border border-stone-200 bg-white p-4 transition-colors hover:border-stone-300">
        ...
        <div class="hidden overflow-hidden rounded-2xl border border-stone-200 bg-white sm:block">
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        {#each orders.data as order}
                            <tr onclick={() => router.visit(order.url)} style="cursor: pointer;" class="border-t border-stone-50 transition-colors hover:bg-stone-50/50">
                                <td class="px-4 py-3">
